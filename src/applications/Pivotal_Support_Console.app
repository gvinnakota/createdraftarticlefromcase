...
<CustomApplication xmlns="http://soap.sforce.com/2006/04/metadata">
    <consoleConfig>
        ...
        <footerColor>#0E7C6B</footerColor>
        <headerColor>#0E7C6B</headerColor>
        <keyboardShortcuts>
            <defaultShortcuts>
        ...
        <primaryTabColor>#0E7C6B</primaryTabColor>
    </consoleConfig>
    <defaultLandingTab>standard-home</defaultLandingTab>
    <isServiceCloudConsole>true</isServiceCloudConsole>
    <label>Pivotal Support Console</label>
    <logo>Communities_Shared_Document_Folder1/PIVOTAL_Logo_png1.png</logo>
    <preferences>
    ...
    <tabs>Project_Time_Entry__c</tabs>
    <tabs>Success_Team__c</tabs>
    <tabs>Exception_Log__c</tabs>
    <tabs>Special_Handling_Instructions__c</tabs>
    <tabs>SalesHoodPlugin__App_Credential__c</tabs>
    <tabs>Revenue_Splits_Request__c</tabs>
    <tabs>Scoping__c</tabs>
    ...
    <workspaceConfig>
        ...
        <mappings>
            <tab>SalesHoodPlugin__App_Credential__c</tab>
        </mappings>
        <mappings>
            <tab>Scoping__c</tab>
        </mappings>
